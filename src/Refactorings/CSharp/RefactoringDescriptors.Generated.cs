...
namespace Roslynator.CSharp.Refactorings
{
    public static class RefactoringDescriptors
    {
        ...
        public static RefactoringDescriptor ExpandLinqMethodOperation = new RefactoringDescriptor("RRX002", "roslynator_refactoring.expand_linq_method_operation.enabled", isEnabledByDefault: true);
