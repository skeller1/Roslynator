...
namespace Roslynator.CSharp.Refactorings
{
    public static class RefactoringDescriptors
    {
        ...
        public static RefactoringDescriptor MoveLocalFunction = new RefactoringDescriptor("RRX005", "roslynator_refactoring.move_local_function.enabled", isEnabledByDefault: true);
